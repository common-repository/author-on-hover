...
if ( ! class_exists( 'AOH_Setup' ) ) {
	class AOH_Setup {
		...
		public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
			...
			echo wp_kses_post( '<div class="aoh-field aoh-field-' . $field_type . $is_pseudo . $class . $visible . '"' . $depend . '>' );
			...
			if ( ! empty( $field_type ) ) {
				...
				if ( ! empty( $field['title'] ) ) {
					...
					echo ( ! empty( $field['subtitle'] ) ) ? '<div class="aoh-subtitle-text">' . wp_kses_post( $field['subtitle'] ) . '</div>' : '';
					echo '</div>';
				}
